...
const sumaApproved = exams.reduce ((acc, student) => acc + student.score, 0);
  console.log(sumaApproved);
...
const suma = array.reduce ((acc, student) => acc + student.score, 0);
console.log(suma);

// 7.3 Dado el mismo array, haz la media de las notas de todos los examenes .reduce().

 const sumaForAverage = exams.reduce ((acc, student) => acc + student.score, 0);
 let average = sumaForAverage/exams.length
 console.log(average);